...
<p align="center">
  <img src="https://img.shields.io/badge/版本-1.28.0-blue.svg" alt="版本">
...
#### 🎉 新功能
- ✨ **教学文档搜索升级**：搜索结果精确到三级标题，快速定位具体内容
- 🎨 **关键词高亮**：搜索关键词在文档中自动高亮显示，方便查看
- 🔖 **保持搜索状态**：切换文档时保持搜索和高亮，方便对比查看
- 📊 **Mermaid流程图**：教学文档支持Mermaid流程图，直观展示工作流逻辑
- 💾 **文档导出**：支持下载单个文档或全部文档为Markdown文件

#### 🐛 Bug修复
- 🔧 **修复SendInput API错误**：修复"真实鼠标点击"、"真实键盘"、"宏录制器"模块的类型错误
- 🌐 **修复浏览器启动问题**：修复Edge浏览器在持久化模式下启动失败的问题（感谢GitHub用户wpqdjncf）
- 📁 **修复工作流保存**：修复工作流保存文件夹留空时无法识别的问题
- 📱 **修复手机坐标选择器**：修复在不同设备上点击坐标不准确的问题，支持横竖屏自动适配

#### 🎨 UI优化
- 📐 **流程图尺寸优化**：增大Mermaid流程图显示尺寸，提升可读性
- 🎯 **搜索结果优化**：显示标题层级（#、##、###）用不同颜色标识
- 💡 **交互体验提升**：优化搜索框交互，支持快速清除和重新搜索

#### 🔧 技术改进
- ⚡ **React 19升级**：升级到React 19，提升性能和稳定性
- 📦 **依赖更新**：更新Mermaid等关键依赖到最新版本
- 🏗️ **代码优化**：优化Markdown渲染器，支持更多自定义功能
